...
I have also done the following steps to auto-generate and auto-commit this readme file -
1. Copied the generate-readme.sh file from root to the git hooks folder - cp generate-readme.sh .git/hooks/pre-commit.d/generate-readme.sh
2. Added the following line to the .git/hooks/pre-commit file - .git/hooks/pre-commit.d/generate_readme.sh
3. Ensure that pre-commit file is executable - 'chmod +x pre-commit'
4. Alternatively to manually generate readme you can also run -  ./generate-readme.sh  from your terminal
...
- [/longestSubstringContainingEvenVowels/LongestSubstringContainingEvenVowels.md](src/main/java/com/leetcode/longestSubstringContainingEvenVowels/LongestSubstringContainingEvenVowels.md)
...
- [/validateIPAddress/ValidateIPAddress.md](src/main/java/com/leetcode/validateIPAddress/ValidateIPAddress.md)
...
- [/xor/XorQueriesOfSubarray/XorQueriesOfSubarray.md](src/main/java/com/leetcode/xor/XorQueriesOfSubarray/XorQueriesOfSubarray.md)
...
- [/linkedList/removeLinkedListElements/RemoveLinkedListElements.md](src/main/java/com/leetcode/linkedList/removeLinkedListElements/RemoveLinkedListElements.md)
...
- [/minTimeDifference/MinTimeDifference.md](src/main/java/com/leetcode/minTimeDifference/MinTimeDifference.md)
...
- [/group_anagrams/GroupAnagramsProblemStatement.md](src/main/java/com/leetcode/group_anagrams/GroupAnagramsProblemStatement.md)
...
- [/validPalindrome2/ValidPalindrome2.md](src/main/java/com/leetcode/validPalindrome2/ValidPalindrome2.md)
...
- [/topKfrequentWords/TopKFrequentWordsStatement.md](src/main/java/com/leetcode/topKfrequentWords/TopKFrequentWordsStatement.md)
